...
const FIRE_BASE_URL = environment.FIRE_BASE_URL;
...
export class RequestServiceBase {
  ...
  // }
  public httpGet<T>(path) {
    return this.http.get(`${FIRE_BASE_URL}${path}`, this.getHttpOptions()).pipe(
      map(this.handleResponse));
  }
  ...
  */
   ...
   * @param body body object
   */
  public httpPostAuth(path, body = {}) {
    // return this.http.post(`${BASE_URL}${path}`, body, this.getHttpOptions()).pipe(map(this.handleResponse));
    return this.http.post(`${BASE_URL}${path}`, body, this.getHttpOptions()).pipe(map(this.handleResponse));
  }
  public httpPost(path, body = {}) {
    // return this.http.post(`${BASE_URL}${path}`, body, this.getHttpOptions()).pipe(map(this.handleResponse));
    return this.http.post(`${FIRE_BASE_URL}${path}`, body, this.getHttpOptions()).pipe(map(this.handleResponse));
  }
  ...
  public httpPut(path, body = {}) {
    ...
    return this.http.put(`${FIRE_BASE_URL}${path}`, body, this.getHttpOptions()).pipe(map(this.handleResponse));
  }
  ...
  public httpDelete(path) {
    ...
    return this.http.delete(`${FIRE_BASE_URL}${path}`, this.getHttpOptions()).pipe(map(this.handleResponse));
  }
